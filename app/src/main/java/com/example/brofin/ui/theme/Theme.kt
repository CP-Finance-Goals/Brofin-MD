...
private val DarkColorScheme = darkColorScheme(
    ...
    tertiary = Color(0xFF38A169),      // Hijau tua untuk warna pelengkap
    onTertiary = Color.White,          // Warna teks pada warna pelengkap
    background = Color(0xFF1A202C),    // Warna latar belakang gelap dan santai
...
private val LightColorScheme = lightColorScheme(
    ...
    onPrimary = Color.White,           // Warna teks pada warna utama
    secondary = Color(0xFF38A169),     // Hijau tua sebagai warna sekunder untuk kesan alami
    onSecondary = Color.White,         // Warna teks pada warna sekunder
    tertiary = Color(0xFF2B6CB0),      // Biru sebagai warna pelengkap
    onTertiary = Color.White,          // Warna teks pada warna pelengkap
